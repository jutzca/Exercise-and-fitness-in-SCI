...
# Forest plot
par(mar=c(4,4,0,2))
forest(REM_PPORCT, ylim = c(-1,12), xlim = c(-90, 60), at = c(-30, -15, 0, 15, 30), cex=0.4, digits = c(0,0),
...
text(c(-65, -59, -53, -47, -41, -35), 10.5, c('Mean', 'SD', 'Total N', 'Mean', 'SD', 'Total N'), cex=0.3)
text(c(-59, -41), 11.5, c('Control', 'Intervention'), cex=0.3)
text(53, 10.5, cex=0.4, bquote(paste(bold("MD [95% CI]"))))
text(-85, 10.5, cex=0.4, bquote(paste(bold("Study"))))
text(44, 10.5, cex=0.4, bquote(paste(bold("Weight"))))
