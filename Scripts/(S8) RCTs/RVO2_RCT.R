...
# Forest plot
par(mar=c(4,4,0,2))
forest(REM_RVO2RCT, ylim = c(-1,17), xlim = c(-50, 25), at = c(-10, -5, 0, 5, 10), cex=0.4, digits = c(1,0),
...
text(c(-35, -31, -27, -23, -19, -15), 15.5, c('Mean', 'SD', 'Total N', 'Mean', 'SD', 'Total N'), cex=0.3)
text(c(-31, -19), 16.5, c('Control', 'Intervention'), cex=0.3)
text(21.25, 15.5, cex=0.4, bquote(paste(bold("MD [95% CI]"))))
text(-47.5, 15.5, cex=0.4, bquote(paste(bold("Study"))))
text(16.25, 15.5, cex=0.4, bquote(paste(bold("Weight"))))
