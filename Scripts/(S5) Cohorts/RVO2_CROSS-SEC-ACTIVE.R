...
# Forest plot
par(mar=c(4,4,0,2))
forest(REM_RVO2CSACT, ylim = c(-2,6), xlim = c(-95, 65), at = c(-20, -10, 0, 10, 20), rows = c(3:1), cex=0.4, digits = c(1,0),
...
text(c(-65, -58, -51, -44, -37, -30), 4.5, c('Mean', 'SD', 'Total N', 'Mean', 'SD', 'Total N'), cex=0.35)
text(c(-58, -37), 5, c('Inactive', 'Active'), cex=0.35)
text(42, 4.5, cex=0.4, bquote(paste(bold("Weight"))))
text(55, 4.5, cex=0.4, bquote(paste(bold("MD [95% CI]"))))
text(-88.7, 4.5, cex=0.4, bquote(paste(bold("Study"))))

text(-66, -0.94, cex=0.4, bquote(paste(": p < 0.001", 
