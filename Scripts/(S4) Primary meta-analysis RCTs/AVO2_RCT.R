...
# Forest plot
par(mar=c(4,4,0,2))
forest(REM_AVO2RCT, ylim = c(-1,16), xlim = c(-5.5,3), alim = c(-1,1), cex=0.4,
...
text(c(-4, -3.5, -3, -2.5, -2, -1.5), 14.5, c('Mean', 'SD', 'Total N', 'Mean', 'SD', 'Total N'), cex=0.3)
text(c(-3.5, -2), 15.5, c('Control', 'Intervention'), cex=0.3)
text(2.55, 14.5, cex=0.4, bquote(paste(bold("MD [95% CI]"))))
text(-5.22, 14.5, cex=0.4, bquote(paste(bold("Study"))))
text(1.8, 14.5, cex=0.4, bquote(paste(bold("Weight"))))
