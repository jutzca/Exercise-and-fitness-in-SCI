...
# Forest plot
par(mar=c(4,4,0,2))
forest(REM_RVO2CS, ylim = c(-2,13), xlim = c(-100, 65), at = c(-20, -10, 0, 10, 20), rows = c(10:1), cex=0.4,
...
text(c(-65, -58, -51, -44, -37, -30), 11.5, c('Mean', 'SD', 'Total N', 'Mean', 'SD', 'Total N'), cex=0.35)
text(c(-58, -37), 12, c('Inactive', 'Active'), cex=0.35)
text(40, 11.5, cex=0.4, bquote(paste(bold("Weight"))))
text(56, 11.5, cex=0.4, bquote(paste(bold("MD [95% CI]"))))
text(-94, 11.5, cex=0.4, bquote(paste(bold("Study"))))

text(-68, -0.94, cex=0.4, bquote(paste(": p < 0.001", 
...
# Egger's test
regtest(REM_RVO2CS, model = "rma", ret.fit = FALSE, digits = 2)
